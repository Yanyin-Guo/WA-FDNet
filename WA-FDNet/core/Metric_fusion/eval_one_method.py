...
def evaluation_one_method_fast(dataset_name='NSLSR_test', data_dir='./data', result_dir='/IRFusion-main/LSFDNet/test/NSLSR/LSFDNet_320', save_dir='/IRFusion-main/LSFDNet/test/metric_LSFDNet.xlsx', Method='LSFDNet' , with_mean=True, crop_size=(768,768)):
    EN_list = []
    SF_list = []
    AG_list = []
    SD_list = []
...
def evaluation_one_method(dataset_name='NSLSR_test', data_dir='./data/', result_dir='/IRFusion-main/LSFDNet/test/NSLSR/LSFDNet_320', save_dir='/IRFusion-main/LSFDNet/test/metric_LSFDNet.xlsx', Method='LSFDNet' , with_mean=True, crop_size=(768,768)):
    EN_list = []
    MI_list = []
    SF_list = []
    AG_list = []
...
def evaluation_one_method_test(dataset_name='NSLSR_test', data_dir='./data/', result_dir='/IRFusion-main/LSFDNet/test/NSLSR/LSFDNet_320', save_dir='/IRFusion-main/LSFDNet/test/metric_LSFDNet.xlsx', Method='LSFDNet' , with_mean=True, crop_size=(768,768)):
    MI_list = []
    # SF_list = []
    VIF_list = []
    PSNR_list = []
...
if __name__ == '__main__':   
    EN, MI, SF, AG, SD, CC, SCD, VIF, MSE, PSNR, Qabf, Nabf, SSIM, MS_SSIM = evaluation_one_method(dataset_name='MSRS_test', data_dir='/data/gyy/MSRS_test', result_dir='/home/gyy/IRFusion-main/LSFDNet/core/Metric_fusion/Results/WAFDNet2', save_dir='/home/gyy/IRFusion-main/LSFDNet/core/Metric_fusion/metric/metric_VI_480_WAFDNet.xlsx', Method='VI', with_mean=True, crop_size=(480,480))